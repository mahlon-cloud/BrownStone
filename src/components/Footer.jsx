...
export default function Footer() {
  ...
  const handleToTop = (e) => {
    ...
    if (typeof window !== 'undefined') {
      // Scroll to top of current page smoothly
  ...
  return (
    <footer className="w-full bg-[#00334b] text-gray-200 relative">
      <div className="w-full max-w-7xl mx-auto px-6 lg:px-20 py-12 grid md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link href="/townhouse" className="hover:underline">Properties</Link></li>
      ...
      <button
        onClick={handleToTop}
        className="absolute right-6 bottom-2 md:bottom-8 p-1 flex items-center gap-3 bg-[#EF641C] text-white md:px-3 md:py-2 rounded-full shadow-lg hover:opacity-95 cursor-pointer"
        aria-label="To Top"
      >
